...
export default function EditItemDialog({
  ...
  const {
    ...
    defaultValues: {
      ...
      purchasePrice: String(Number(item.purchasePrice).toFixed(2)),
      targetPrice: item.targetPrice ? String(Number(item.targetPrice).toFixed(2)) : "",
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative z-10 w-full max-w-lg rounded-xl border border-border bg-background p-6 shadow-xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-5">
              <h2 className="text-base font-semibold">Item bearbeiten</h2>
              <button
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input {...register("brand")} className={inputClass()} placeholder="z.B. Nike" />
                </div>

                {/* Größe */}
                <div>
                  <label className={labelClass}>Größe</label>
                  <input {...register("size")} className={inputClass()} placeholder="z.B. 42 / M" />
                </div>
